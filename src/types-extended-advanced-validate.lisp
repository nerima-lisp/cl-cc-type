...
the cl-cc-type/test components, for the same reason). Since there is nothing to
query, this permissively returns T rather than treating the absent registry as
an unmet obligation —
